...
const SIDECAR_SERVICE_NAME = "bigmancode server"
...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...
    BIGMANCODE_EXPERIMENTAL_ICON_DISCOVERY: "true",
    BIGMANCODE_EXPERIMENTAL_FILEWATCHER: "true",
...
function createSidecarEnv(): Record<string, string> {
  ...
  if (!app.isPackaged) env.BIGMANCODE_DISABLE_CHANNEL_DB = "1"
  return env
}
