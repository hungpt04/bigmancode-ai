...
const releaseId = process.env.BIGMANCODE_RELEASE
if (!releaseId) throw new Error("BIGMANCODE_RELEASE is required")

const version = process.env.BIGMANCODE_VERSION
if (!version) throw new Error("BIGMANCODE_VERSION is required")
