...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.BIGMANCODE_WEBSEARCH_PROVIDER === "exa" || process.env.BIGMANCODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.BIGMANCODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("BIGMANCODE_EXPERIMENTAL") || truthy("BIGMANCODE_ENABLE_EXA") || truthy("BIGMANCODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("BIGMANCODE_ENABLE_PARALLEL") || truthy("BIGMANCODE_EXPERIMENTAL_PARALLEL"),
