...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BIGMANCODE_CALLER", () => {
    process.env["BIGMANCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BIGMANCODE_CALLER", () => {
    process.env["BIGMANCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BIGMANCODE_CALLER", () => {
    process.env["BIGMANCODE_CALLER"] = "unknown"
