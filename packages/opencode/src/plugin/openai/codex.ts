          ...
          authorize: async () => {
            const deviceResponse = await fetch(`${ISSUER}/api/accounts/deviceauth/usercode`, {
              ...
              headers: {
                ...
                "User-Agent": `bigmancode/${InstallationVersion}`,
              },
...
"User-Agent": `bigmancode/${InstallationVersion}`,
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "bigmancode"
      output.headers["User-Agent"] = `bigmancode/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
