export const dict = {
  ...
  "dialog.provider.BIGMAN Code.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.BIGMAN Code.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.BIGMAN CodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af BIGMAN Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i BIGMAN Code.",
  ...
  "provider.connect.BIGMAN CodeZen.line1":
    "BIGMAN Code Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.BIGMAN CodeZen.visit.prefix": "Besøg ",
  "provider.connect.BIGMAN CodeZen.visit.link": "BIGMAN Code.ai/zen",
  "provider.connect.BIGMAN CodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i BIGMAN Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i BIGMAN Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i BIGMAN Code.json",
  ...
  "dialog.server.description": "Skift hvilken BIGMAN Code-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af BIGMAN Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til BIGMAN Code-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (BIGMAN Code.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, BIGMAN Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "BIGMAN Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør BIGMAN Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for BIGMAN Code",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan BIGMAN Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om BIGMAN Code følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan BIGMAN Code er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når BIGMAN Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af BIGMAN Code.",
