export const dict = {
  ...
  "dialog.provider.BIGMAN Code.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.BIGMAN Code.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.BIGMAN CodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje BIGMAN Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u BIGMAN Code-u.",
  ...
  "provider.connect.BIGMAN CodeZen.line1":
    "BIGMAN Code Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.BIGMAN CodeZen.visit.prefix": "Posjeti ",
  "provider.connect.BIGMAN CodeZen.visit.link": "BIGMAN Code.ai/zen",
  "provider.connect.BIGMAN CodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u BIGMAN Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u BIGMAN Code-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u BIGMAN Code.json",
  ...
  "dialog.server.description": "Promijeni na koji se BIGMAN Code server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija BIGMAN Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku BIGMAN Code timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (BIGMAN Code.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: BIGMAN Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BIGMAN Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni BIGMAN Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u BIGMAN Code-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako BIGMAN Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li BIGMAN Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu BIGMAN Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se BIGMAN Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju BIGMAN Code-a.",
