...
export const dict = {
  ...
  "dialog.provider.BIGMAN Code.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.BIGMAN Code.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.BIGMAN CodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av BIGMAN Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i BIGMAN Code.",
  ...
  "provider.connect.BIGMAN CodeZen.line1":
    "BIGMAN Code Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.BIGMAN CodeZen.visit.prefix": "Besøk ",
  "provider.connect.BIGMAN CodeZen.visit.link": "BIGMAN Code.ai/zen",
  "provider.connect.BIGMAN CodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i BIGMAN Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i BIGMAN Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i BIGMAN Code.json",
  ...
  "dialog.server.description": "Bytt hvilken BIGMAN Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av BIGMAN Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til BIGMAN Code-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (BIGMAN Code.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at BIGMAN Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "BIGMAN Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør BIGMAN Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for BIGMAN Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan BIGMAN Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om BIGMAN Code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan BIGMAN Code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når BIGMAN Code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av BIGMAN Code.",
