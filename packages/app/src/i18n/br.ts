export const dict = {
  ...
  "dialog.provider.BIGMAN Code.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.BIGMAN Code.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.BIGMAN CodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo BIGMAN Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no BIGMAN Code.",
  ...
  "provider.connect.BIGMAN CodeZen.line1":
    "BIGMAN Code Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.BIGMAN CodeZen.visit.prefix": "Visite ",
  "provider.connect.BIGMAN CodeZen.visit.link": "BIGMAN Code.ai/zen",
  "provider.connect.BIGMAN CodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no BIGMAN Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no BIGMAN Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados em BIGMAN Code.json",
  ...
  "dialog.server.description": "Trocar para qual servidor BIGMAN Code este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do BIGMAN Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do BIGMAN Code",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (BIGMAN Code.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: BIGMAN Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "BIGMAN Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor BIGMAN Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do BIGMAN Code",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o BIGMAN Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o BIGMAN Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o BIGMAN Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o BIGMAN Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do BIGMAN Code.",
