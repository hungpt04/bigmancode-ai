export const dict = {
  ...
  "dialog.provider.BIGMAN Code.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.BIGMAN Code.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.BIGMAN CodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez BIGMAN Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w BIGMAN Code.",
  ...
  "provider.connect.BIGMAN CodeZen.line1":
    "BIGMAN Code Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.BIGMAN CodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.BIGMAN CodeZen.visit.link": "BIGMAN Code.ai/zen",
  "provider.connect.BIGMAN CodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w BIGMAN Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w BIGMAN Code.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w BIGMAN Code.json",
  ...
  "dialog.server.description": "Przełącz serwer BIGMAN Code, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja BIGMAN Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu BIGMAN Code",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (BIGMAN Code.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "BIGMAN Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla BIGMAN Code",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd BIGMAN Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy BIGMAN Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw BIGMAN Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania BIGMAN Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji BIGMAN Code.",
