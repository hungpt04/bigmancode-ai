export const dict = {
  ...
  "dialog.provider.BIGMAN Code.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.BIGMAN Code.tagline": "Reliable optimized models",
  "dialog.provider.BIGMAN CodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by BIGMAN Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in BIGMAN Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.BIGMAN CodeZen.line1":
    "BIGMAN Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.BIGMAN CodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.BIGMAN CodeZen.visit.prefix": "Visit ",
  "provider.connect.BIGMAN CodeZen.visit.link": "BIGMAN Code.ai/zen",
  "provider.connect.BIGMAN CodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in BIGMAN Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in BIGMAN Code.",
  ...
  "dialog.plugins.empty": "Plugins configured in BIGMAN Code.json",
  ...
  "dialog.server.description": "Switch which BIGMAN Code server this app connects to.",
  ...
  "wsl.onboarding.step.BIGMAN Code": "BIGMAN Code",
  ...
  "wsl.onboarding.checkingBIGMAN Code": "Checking BIGMAN Code...",
  "wsl.onboarding.checkingBIGMAN CodeIn": "Checking BIGMAN Code in {{distro}}...",
  "wsl.onboarding.updatingBIGMAN Code": "Updating BIGMAN Code...",
  "wsl.onboarding.updatingBIGMAN CodeIn": "Updating BIGMAN Code in {{distro}}...",
  "wsl.onboarding.updateBIGMAN CodeIn": "Update BIGMAN Code in {{distro}}.",
  "wsl.onboarding.updateBIGMAN Code": "Update BIGMAN Code",
  "wsl.onboarding.BIGMAN CodeReadyIn": "BIGMAN Code is ready in {{distro}}.",
  "wsl.onboarding.BIGMAN CodeReady": "BIGMAN Code is ready.",
  "wsl.onboarding.installBIGMAN CodeIn": "Install BIGMAN Code in {{distro}}.",
  "wsl.onboarding.installBIGMAN Code": "Install BIGMAN Code",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen BIGMAN Code.",
  ...
  "toast.update.description": "A new version of BIGMAN Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the BIGMAN Code team",
  ...
  "error.chain.checkConfig": "Check your config (BIGMAN Code.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, BIGMAN Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "BIGMAN Code includes free models so you can start immediately.",
  ...
  "app.name.desktop": "BIGMAN Code Desktop",
  ...
  "settings.desktop.wsl.description": "Run the BIGMAN Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for BIGMAN Code",
  ...
  "settings.general.row.appearance.description": "Customise how BIGMAN Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether BIGMAN Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how BIGMAN Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when BIGMAN Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of BIGMAN Code.",
