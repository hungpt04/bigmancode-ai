...
export const dict = {
  ...
  "dialog.provider.BIGMAN Code.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.BIGMAN Code.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.BIGMAN CodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "BIGMAN Code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve BIGMAN Code'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.BIGMAN CodeZen.line1":
    "BIGMAN Code Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.BIGMAN CodeZen.visit.prefix": "",
  "provider.connect.BIGMAN CodeZen.visit.link": "BIGMAN Code.ai/zen",
  "provider.connect.BIGMAN CodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve BIGMAN Code'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak BIGMAN Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler BIGMAN Code.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi BIGMAN Code sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "BIGMAN Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı BIGMAN Code ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (BIGMAN Code.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: BIGMAN Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "BIGMAN Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "BIGMAN Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "BIGMAN Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "BIGMAN Code'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "BIGMAN Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "BIGMAN Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "BIGMAN Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "BIGMAN Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "BIGMAN Code'un en son sürümünü kullanıyorsunuz.",
